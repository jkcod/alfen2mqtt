...
describe("Rest Client testing", () => {
    test('Get Wellbox Data (with Login)', async () => {
        ...
        mock.onPost(restClient.getBaseUrl() + "/login", requestBody).reply(200)
        .onGet(restClient.getBaseUrl() + "/prop?ids=2060_0,2056_0,2221_3,2221_4,2221_5,2221_A,2221_B,2221_C,2221_16,2201_0,2501_2,2221_22", requestBody).reply(200)
